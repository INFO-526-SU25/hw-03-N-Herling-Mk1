...
```
<div class="note-box "> 
<b>Q4 - conclusions</b><br>
When the percentiles are shrunk to 25-75%, the shape of the statistics change significantly.
The visual effect is far more agreement amongst those surveyed,i.e., the data looks much more closely grouped to the mean.
</div>
...
<div class="note-box "> 
<b>Q5c - c. Comment on how the two charts from parts (a) and (b) compare with regards to comparability.</b><br>
The two bar charts are excellent aids in concert with the larger grid. The overwhelming '1' likert score can be seen better with these visualizations, and the sense that the only 'negative' responses were really 'ambivalence or uncertainty' rather than concern.
</div>
