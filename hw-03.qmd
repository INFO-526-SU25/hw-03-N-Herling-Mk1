  ...
  ggplot(data, aes(x = explanatory_value, y = mean)) +
    ...
    theme(
      ...
      strip.text.y.right = element_text(
        angle = 0,
        vjust = 0.5,
        margin = margin(t = 15, b = 15, r = 25, l = 25)
      ),
  ...
  ggplot(data, aes(x = explanatory_value, y = mean, group = explanatory_value)) +
    ...
    theme(
      ...
      strip.text.y.right = element_text(
        angle = 0,
        vjust = 0.5,
        margin = margin(t = 10, b = 10, r = 19, l = 19)
      ),
      axis.text.y = element_text(size = 10),
      panel.spacing = unit(1, "lines"),
      axis.text.x = element_blank(),
...
plot_ethnicity <- function(data, sub_title_specific) {
  ggplot(data, aes(x = explanatory_value, y = mean, group = explanatory_value)) +
    ...
    labs(
      ...
      caption = "Citation: The data collected by Pavan Shah, Giorgio Caturegli, Galen Shi, and Joshua Materi at the Johns Hopkins School of Medicine.\n We thank Giorgio Caturegli for providing access to the dataset. This visualization is based on their survey results."
    ) +
    theme(
...
The data supplied and the assumptions made from it are summarized below.
...
#| label: label-me-4
#| fig.width: 10   # width in inches
#| fig.height: 10s   # height in inches
